...
public class DeltaCommitter implements Committer<DeltaSinkCommittable> {
    ...
    @Override
    public List<DeltaSinkCommittable> commit(List<DeltaSinkCommittable> committables) throws IOException {
        for (DeltaSinkCommittable committable : committables) {
